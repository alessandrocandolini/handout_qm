...
\addbibresource{~/canguro/mylatex/myBibliography9.bib}            % database di biblatex 
%\usepackage{MyriadPro}
%\renewcommand{\familydefault}{\sfdefault} 
%\renewcommand{\sfdefault}{MyriadPro-LF}
\usepackage{eucal}      % ams \mathcal{}, prettier, a little too light maybe?
\usepackage[opticals,fullfamily,mathlf,onlytext]{MinionPro}
%\usepackage[opticals,fullfamily,mathlf]{MinionPro}
