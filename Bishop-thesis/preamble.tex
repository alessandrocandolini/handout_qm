...
\PassOptionsToPackage{final,\hyperoptions hyperfootnotes=false,linktoc=all}{hyperref}
\usepackage{hyperref}
...
\sethead
[\sffamily\thepage\quad$\vert$\quad\chaptertitle]% even-left
[]% even-centre
[]% even-right
{}% odd-left
{}% odd-centre
{\sffamily\thesection~\sectiontitle\quad$\vert$\quad\thepage}% odd-right
}
\pagestyle{main} % use the fancy header
