...
different from $\varphi$ itself. 
  ...
  \Cref{def:limit} might not look practically useful: if there's a candidate $l$, the definition determines unambiguously whether $l$ is or is not the limit, but the identification of a target $l$ needs to happen by other means. It's possible to develop a calculus by \begin{inparaenum}[a)] 
