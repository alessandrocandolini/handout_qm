...
\begin{remark}
   As a special case, 
  we recover the arithmetic-geometric mean inequality 
   for $\vartheta = 1/2$:
   \begin{dmath*}
...
\begin{proof}
   ...
   Let us discuss what happens when $\vartheta \neq 0,1$.
   The first-order derivative is 
   \begin{dmath*}
      \D{f(x)}{x} 
      = 
      \vartheta \left(  x^{\vartheta - 1} - 1\right )
   \end{dmath*};
   since %
  $0< \vartheta < 1$, 
   we have 
   \begin{math}
      \D{f(x)}{x}  \geq 0 
   \end{math} 
  if and only if  $0 < x \leq 1 $, and 
   \begin{math}
      \D{f(x)}{x}  <  0 
   \end{math} 
   for $x> 0 $.
   This means that $x = 1$ is a maximum  of $f_{\vartheta}$.
