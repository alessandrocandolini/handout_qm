...
\textcite{Teschl:2009,Berberian:1976,Hutson.Pym:1980,Debnath.Mikusinski:2005}.
...
\begin{remark}
   ...
   \begin{dmath}
      \braket{\varphi|\psi} = \frac{1}{4} \sum_{k=1}^{4} \ii^{k} \Norm{ \varphi +
	 \ii^{k} \psi}^{2}
   \end{dmath}.
\end{remark}
...
\sum_{k=1}^{N} \conj{\left( \psi_{k} \conj{\varphi_{k}}  \right)}
	...
	\begin{theorem}[Pythagorean theorem]
	   ...
	   \begin{enumerate}
		 ...
		 \begin{dmath*}
		    \Norm{\sum_{k=1}^{N} \varphi_{k}}^{2} = \sum_{k=1}^{N}
		    \Norm{\varphi_{k}}^{2}
		 \end{dmath*}
	      \item 
		 ...
		 identity:
		 \begin{dmath*}
		    \Norm{ \sum_{k=1}^{+\infty}\varphi_{k}} ^{2} =
		    \sum_{k=1}^{+\infty} \Norm{\varphi_{k}}^{2}
		 \end{dmath*}.
	   \end{enumerate}
	      \end{theorem}
	      \begin{proof}
	...
	Now, let's check  that 
		 ...
		 \begin{dmath*}
		    \Norm{\sum_{k=1}^{N+1} \varphi_{k}}^{2} = \sum_{k=1}^{N+1}
		    \Norm{\varphi_{k}}^{2}
		 \end{dmath*}
		 for $N+1$. 
		 We have 
